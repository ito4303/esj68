...
\includegraphics[width=11cm]{presence-absence.pdf}
...
& \sum_{n=\mathrm{max}(\boldsymbol{Y})}^{\infty}\mathrm{Poisson}(n \mid \lambda)\prod_{j=1}^{J}\mathrm{Binom}(Y_{j} \mid n, p_{j})
\end{align*}
